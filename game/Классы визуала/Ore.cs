...
namespace game
{
    internal class Ore : Sprites
    {
        ...
        static readonly SolidBrush fourth_ore_brush = new SolidBrush(Color.FromArgb(255, 128, 128, 128));
        static readonly SolidBrush fifth_ore_brush = new SolidBrush(Color.FromArgb(255, 128, 128, 128));
